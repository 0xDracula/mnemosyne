...
GRANT INSERT, SELECT ON ALL TABLES IN SCHEMA raw TO pipeline_writer;
ALTER DEFAULT PRIVILEGES IN SCHEMA raw GRANT INSERT, SELECT ON TABLES TO pipeline_writer;
